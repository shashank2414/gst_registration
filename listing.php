...
$listingsql = "SELECT * FROM gst_data_tbl";
...
<body>
    ...
    <?php if ($result && count($result) > 0): ?>
        <center class='mt-4'>
            <h2><u>GST Registration Data</u></h2>
        </center>
        <div class='container'>
            <table class='table table-light table-hover mt-4 p-3'>
                ...
                <?php foreach ($result as $row): ?>
                    <tr class='align-middle'>
                        <td>id: <?= $row["id"] ?><br>Pan: <?= $row['user_pan_number'] ?><br>Firm Name: <?= $row['firm_name'] ?><br><?= $row['firm_address'] ?></td>
                        ...
                        <td>Pan: <?= $row["user_pan_number"] ?><br>
                            ...
                            <a target="_blank" href="<?= $row['aadhar_f_url'] ?>">Aadhar Card (Front)</a><br>
                            <a target="_blank" href="<?= $row['aadhar_b_url'] ?>">Aadhar Card (Back)</a><br>
                            <a target="_blank" href="<?= $row['user_photo_url'] ?>">User Photo</a><br>
                            <a target="_blank" href="<?= $row['electricity_bill_url'] ?>">Electricity Bill</a><br>
                            <a target="_blank" href="<?= $row['rent_agreement_url'] ?>">Rent Agreement</a><br>
                            <a target="_blank" href="<?= $row['relative_noc_url'] ?>">Relative Noc</a><br>
                            <a target="_blank" href="<?= $row['other_doc_url'] ?>">Other Docs</a>
                        </td>
                        <td>
