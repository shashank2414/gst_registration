...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM gst_data_tbl WHERE id = :id";
...
<body>
    ...
    <div class="container mt-4 w-50 mb-3">
        <form class="border border-success mx-auto p-3" enctype="multipart/form-data" action="update.php" method="post">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">User Photo</label>
                    <div class="input-group">
                        <input type="file" name="new_user_photo_upload_file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">Electricity Bill</label>
                    <div class="input-group">
                        <input type="file" name="new_electricity_bill_upload_file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">Rent Agreement</label>
                    <div class="input-group">
                        <input type="file" name="new_rent_agreement_upload_file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                    </div>
                </div>
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">Relative Noc</label>
                    <div class="input-group">
                        <input type="file" name="new_relative_noc_upload_file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <label for="validationCustom03" class="form-label">Other Doc</label>
                <div class="input-group">
